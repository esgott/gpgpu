...
if (${OPENGL_GL_LIB}   STREQUAL "OPENGL_GL_LIB-NOTFOUND"
    OR
    ${OPENGL_GLU_LIB}  STREQUAL "OPENGL_GLU_LIB-NOTFOUND"
    OR
    ${GLUT_LIB}        STREQUAL "GLUT_LIB-NOTFOUND"
    OR
    ${GLEW_LIB}        STREQUAL "GLW_LIB-NOTFOUND"
    OR
    ${NVIDIA_CG_LIB}   STREQUAL "NVIDIA_CG_LIB-NOTFOUND"
    OR
    ${NVIDIA_CGGL_LIB} STREQUAL "NVIDIA_CGGL_LIB-NOTFOUND"
    OR
    ${DEVIL_IL_LIB}    STREQUAL "DEVIL_IL_LIB-NOTFOUND"
    OR
    ${DEVIL_ILU_LIB}   STREQUAL "DEVIL_ILU_LIB-NOTFOUND"
    OR
