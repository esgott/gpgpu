...
public:
    ...
    float dot(const Vector& dotProductOperand) const {
        return v[0] * dotProductOperand.v[0] + v[1] * dotProductOperand.v[1] + v[2] * dotProductOperand.v[2];
    }

    //cross product
    Vector cross(const Vector& crossProductOperand) const {
        return Vector(v[1] * crossProductOperand.v[2] - v[2] * crossProductOperand.v[1],
    ...
    Vector normalize() const {
        ...
        return Vector(v[0] * lengthInv, v[1] * lengthInv, v[2] * lengthInv);
    }
